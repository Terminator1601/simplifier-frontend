...
import MergedComponent from "./FileUpload.tsx";
...
export default function Simplifier() {
  ...
  const handleFileUpload = async (uploadedFile: File) => {
    ...
    setTimeout(() => {
      setExtractedText([
        "Sample extracted text from PDF page 1",
        "Sample extracted text from PDF page 2",
        "Sample extracted text from PDF page 3",
      ]);
      setIsLoading(false);
    }, 2000);
  };
  ...
  onTextSelection={handleTextSelection}  // Ensure this is a function
  file={file}
/>
